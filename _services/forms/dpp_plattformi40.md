...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:3px; border-width:1px; border-color:#C0CCD9; border-style:solid; direction:ltr">
      <form id="sib-form" method="POST" action="https://87c49aa4.sibforms.com/serve/MUIFAKYNHSrlVKt07Ug7WLa1UxehfOfNRgymRny_Zvr5fjZIHXp4XxWqmvxsH6sGmuC0ssSAenNBIPz13E6ThcXyo05ycuCv6TCEzXM3Drjx8v2B7arGUhT_NgI79fZGlTccIWl7FQAfEVRbJrVPBdm1RM2M_eJa33eu0RfkSFifj9rmsvrR_RwXgcDht41BX0nwXPFjLX6qpgBK" data-type="subscription">
        ...
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="font-size:32px; text-align:left; font-weight:700; font-family:&quot;Titillium Web&quot;, webFonts; color:#3C4858; background-color:transparent; text-align:left">
            <p>Strategie-Workshop Digitaler Produktpass für die Plattform Industrie 4.0</p>
          </div>
        </div>
        <div style="padding: 8px 0;">
